...
then
    ...
    then
        ...
        notify-send -p -r $pid -t 1000 -u critical -i /home/baspar/.icons/ACYL_Icon_Theme_0.9.4/scalable/real_icons/actions/gtk-media-next-ltr.svg "$song - $artist" "$CurrentTime/$TotalTime" > ~/.bin/notifypid
    else
