...
map("n", "<leader>vL", ":tabe ~/.config/nvim/lua/plugins/lsp.lua<CR>")
map("n", "<leader>vl", ":e ~/.config/nvim/lua/plugins/lsp.lua<CR>")
...
map("n", "<leader>vT", ":tabe ~/.config/nvim/lua/plugins/treesitter.lua<CR>")
map("n", "<leader>vt", ":e ~/.config/nvim/lua/plugins/treesitter.lua<CR>")
